...
class Tour(models.Model):
    ...
    small_image = models.ImageField(upload_to='tours/', help_text="Small image for the tour(300w x 200H)")
    bigger_image = models.ImageField(upload_to='tours/', help_text="Bigger image for the tour(1300x680h)")
...
class TourImage(models.Model):
    image = models.ImageField(upload_to='tours/galleries/', help_text="Gallery image")
...
class Pop(models.Model):
    ...
    image = models.ImageField(upload_to='global/', help_text="Image for the pop")
...
class DayTrip(models.Model):
    ...
    small_image = models.ImageField(upload_to='daytrips/', help_text="Small image for the day trip")
    bigger_image = models.ImageField(upload_to='daytrips/', help_text="Bigger image for the day trip")
...
class DayTripImage(models.Model):
    image = models.ImageField(upload_to='daytrips/galleries/', help_text="Day trips images galleries")
...
class Camp(models.Model):
    ...
    hero_image = models.ImageField(upload_to='camps/', help_text="An image for header of the Camp")
    ...
    suite_image = models.ImageField(upload_to='camps/', help_text="Image of the suite")
    ...
    experience_1_image = models.ImageField(upload_to='camps/', help_text="Image for experience 1")
    ...
    experience_2_image = models.ImageField(upload_to='camps/', help_text="Image for experience 2")
    ...
    experience_3_image = models.ImageField(upload_to='camps/', help_text="Image for experience 3")
    dining_image = models.ImageField(upload_to='camps/', help_text="Background image for the dining section")
...
class HomePage(models.Model):
    ...
    hero_image = models.ImageField(upload_to='pages_images/', help_text='An image for header of the page')
    mobile_hero_image = models.ImageField(upload_to='pages_images/', help_text='image For mobile')
    ...
    about_image = models.ImageField(upload_to='pages_images/', default='default_about.jpg')
    ...
    comfort_image = models.ImageField(upload_to='pages_images/', default='default_comfort.jpg')
    class Meta:
...
class StrengthItem(models.Model):
    ...
    background_image = models.ImageField(upload_to='morocco_tours/strengths/', default='default_strength.jpg')
    def __str__(self):
        return self.title
...
class MoroccoToursPage(models.Model):
    ...
    service_image1 = models.ImageField(upload_to='pages_images/', default='default_service1.jpg')
    service_title2 = models.CharField(max_length=255, default="Guided Walking Tour")
    service_image2 = models.ImageField(upload_to='pages_images/', default='default_service2.jpg')
    service_title3 = models.CharField(max_length=255, default="Flexible Rescheduling")
    service_image3 = models.ImageField(upload_to='pages_images/', default='default_service3.jpg')
    ...
    why_choose_image = models.ImageField(upload_to='pages_images', default='default_hero.jpg')
    ...
    strength_image1 = models.ImageField(upload_to='pages_images/', default='default_strength1.jpg')
    strength_title2 = models.CharField(max_length=255, default="Photography Tours")
    strength_image2 = models.ImageField(upload_to='pages_images/', default='default_strength2.jpg')
    strength_title3 = models.CharField(max_length=255, default="Licensed Guides")
    strength_image3 = models.ImageField(upload_to='pages_images/', default='default_strength3.jpg')
    strength_title4 = models.CharField(max_length=255, default="Satisfaction Guaranteed")
    strength_image4 = models.ImageField(upload_to='pages_images/', default='default_strength4.jpg')
    strength_title5 = models.CharField(max_length=255, default="Excellence")
    strength_image5 = models.ImageField(upload_to='pages_images/', default='default_strength5.jpg')
    strength_title6 = models.CharField(max_length=255, default="Trusted Experience")
    strength_image6 = models.ImageField(upload_to='pages_images/', default='default_strength6.jpg')
    steps_image = models.ImageField(upload_to='pages_images/', default='default_hero.jpg')
...
class DayTripsPage(models.Model):
    ...
    service_image1 = models.ImageField(upload_to='pages_images/', help_text='Icon')
    service_title2 = models.CharField(max_length=255, help_text="Guided Walking Tour")
    service_image2 = models.ImageField(upload_to='pages_images/', help_text='Icon')
    service_title3 = models.CharField(max_length=255, help_text="Flexible Rescheduling")
    service_image3 = models.ImageField(upload_to='pages_images/', help_text='Icon')
    ...
    blog_image = models.ImageField(upload_to='pages_images/', help_text='Imgae for your section')
    ...
    unique_experiences_image = models.ImageField(upload_to='pages_images/', help_text='image for your section')
...
class PhotographerTourPage(models.Model):
    ...
    hero_button_text = models.CharField(max_length=50, help_text="Content of your button")
    hero_image_large = models.ImageField(upload_to='pages_images/', help_text='Image for desktop')
    hero_image_medium = models.ImageField(upload_to='pages_images/', help_text='Image Medium')
    hero_image_small = models.ImageField(upload_to='pages_images/', help_text='Small image')
    ...
    image = models.ImageField(upload_to='pages_images/', help_text='image for this section')
    ...
    image_section = models.ImageField(null=True,blank=True, upload_to='pages_images/', help_text='image for this section')
    def __str__(self):
        return self.meta_title
...
class Package(models.Model):
    ...
    image = models.ImageField(upload_to='packages/', help_text="Small image for package Photographer", blank=True, null=True)
...
class DesertCampPage(models.Model):
    ...
    meta_description = models.TextField(help_text="Description of the page (150 up to 160 characters)")
    meta_keywords = models.TextField(help_text="Keywords")
    hero_image = models.ImageField(upload_to='pages_images/', default='default_hero.jpg')
    hero_title = models.CharField(max_length=255, help_text="Marketing Title for users")
    hero_paragraph = models.TextField(help_text="Marketing small paragraphs for users")
    hero_button_text = models.CharField(max_length=255, default="Explore more")
    ...
    first_section_image = models.ImageField(upload_to='pages_images/', default='default_image2.jpg')
    ...
    small_info_image = models.ImageField(upload_to='pages_images/', default='default_small_info.jpg')
    ...
    second_section_image = models.ImageField(upload_to='pages_images/', default='default_image3.jpg')
    def __str__(self):
        return self.meta_title
...
class AboutPage(models.Model):
    ...
    first_section_image = models.ImageField(upload_to='pages_images/', default='default_first_section.jpg')
    ...
    client_care_image = models.ImageField(upload_to='pages_images/', default='default_client_care.jpg')
    ...
    testimonial1_image = models.ImageField(upload_to='pages_images', default='default_testimonial1.jpg')
    ...
    testimonial2_image = models.ImageField(upload_to='pages_images', default='default_testimonial2.jpg')
    ...
    testimonial3_image = models.ImageField(upload_to='pages_images', default='default_testimonial3.jpg')
...
class BlogContentBlock(models.Model):
    ...
    image_content = models.ImageField(upload_to='blogs/', blank=True, null=True)
    alt_text = models.CharField(max_length=255, blank=True, null=True)
    def __str__(self):
